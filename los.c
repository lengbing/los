...
static int los_dump(lua_State* L)
{
    ...
    if (lua_islightuserdata(L, 1)) {
        ...
        luaL_checkany(L, 4);
        lua_settop(L, 4);
        size_t len = dumpbuf(E, L, B + index, size);
...
static int los_dump_x(lua_State* L)
{
    ...
    if (lua_islightuserdata(L, 1)) {
        ...
        luaL_checkany(L, 4);
        lua_settop(L, 4);
        size_t len = dumpbuf_x(E, L, B + index, size);
        lua_pushinteger(L, len);
        return 1;
    }
    else {
...
static int los_load(lua_State* L)
{
    ...
    if (lua_islightuserdata(L, 1)) {
        ...
        size_t size = luaL_checkinteger(L, 3);
        lua_settop(L, 3);
        size_t consume = load(E, L, B + index, size);
...
static int los_load_x(lua_State* L)
{
    ...
    if (lua_islightuserdata(L, 1)) {
        ...
        size_t size = luaL_checkinteger(L, 3);
        lua_settop(L, 3);
        size_t consume = load_x(E, L, B + index, size);
        lua_pushinteger(L, consume);
        lua_rotate(L, -2, 1);
        return 2;
    }
...
static int los_pack(lua_State* L)
{
    ...
    if (lua_islightuserdata(L, 1)) {
        ...
        luaL_checkany(L, 4);
        lua_settop(L, 4);
        size_t len = packbuf(E, L, B + index, size);
        lua_pushinteger(L, len);
        return 1;
    }
    else {
...
static int los_unpack(lua_State* L)
{
    ...
    if (lua_islightuserdata(L, 1)) {
        ...
        size_t size = luaL_checkinteger(L, 3);
        lua_settop(L, 3);
        size_t consume = unpack(E, L, B + index, size);
        lua_pushinteger(L, consume);
        lua_rotate(L, -2, 1);
        return 2;
    }
